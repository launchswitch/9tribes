...
<h3>Learn by Kill</h3>
<p>When your units destroy an enemy, there's a chance they'll <strong>learn</strong> one of that enemy's faction domains. The base chance depends on your unit's veterancy: <strong>Green 10%</strong>, <strong>Seasoned 18%</strong>, <strong>Veteran 24%</strong>, <strong>Elite 35%</strong>. Each unit can hold up to <strong>3 learned abilities</strong>, and you can't learn your own faction's domains — no freebies. Not every kill teaches you something, but veterans are surprisingly good students. This is a gamble worth taking.</p>

<h3>Sacrifice (Codify)</h3>
<p>Once a unit has learned a foreign ability, bring it back to your <strong>home city</strong> and <strong>sacrifice</strong> it. The unit is permanently destroyed, but every domain it learned gets <strong>codified</strong> — added to your faction's research tree. Think of it as passing on hard-won knowledge. You can't sacrifice while your capital is under siege, so protect your home front.</p>
...
<ul>
  ...
  <li><strong>T2 — Mastery (60 XP):</strong> Powers up the domain's effects. More importantly, T2 contributes to <strong>Emergent Rule progress</strong> — the triple-stack combos that define late-game builds. Breadth matters.</li>
  <li><strong>T3 — Transcendence (100 XP):</strong> The payoff. Fully activates <strong>pair synergies</strong> with other T3 domains. If you have Venom T3 and Fortress T3, your poison-tagged fortress units gain the Toxic Bulwark synergy.</li>
</ul>
...
<ul>
  <li><strong>Don't sacrifice your first learner immediately</strong> — a unit with 3 learned abilities is worth more than 3 separate sacrifices, since each sacrifice costs you a trained veteran.</li>
