...
export interface ResearchDoctrine {
  ...
  // T3 upgrades for foreign domains
  poisonBonusEnabled: boolean;       // venom_t3 — poison-tagged units deal +50% poison damage
  fortressAuraUpgradeEnabled: boolean; // fortress_t3 — fortress aura grants +25% defense
  chargeRoutedBonusEnabled: boolean;  // charge_t3 — charge damage +50% against routed enemies
  hitrunZocIgnoreEnabled: boolean;    // hitrun_t3 — units with hitrun ignore zone of control
